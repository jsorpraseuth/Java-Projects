...
public class AdvancedCharacter implements CharacterIF {
    ...
    private final int startingHealth = 50;
    private final int maxInventorySlots = 2;
    ...
    public void setWeapons(List<WeaponIF> weaponList) throws TooManyWeaponsException {
        if (weaponList.size() > maxInventorySlots) throw new TooManyWeaponsException("The max amount of items for a Advanced Character is: " + maxInventorySlots + " You attempted to add " + weaponList.size() + " which exceeds the maximum.");
    ...
    public void doDamage(CharacterIF victim) {
        System.out.println("Advanced Character " + this.getCharacterName() + " is doing damage to " + victim.getCharacterName() + " with Advanced weapon: " +  this.currentWeapon.getWeaponName());
